            ...
            <Container>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="ms-auto gap-4 font-mono">
                        ...
                        <Nav.Link href="#cybersecurity" className="text-gray-300 hover:text-green-400 transition-colors hover:shadow-[0_0_10px_rgba(34,197,94,0.5)]">Cybersecurity</Nav.Link>
